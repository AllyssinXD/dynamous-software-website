              ...
              <ul>
                ...
                <li className="flex items-center h-20">
                  <Image
                    ...
                    alt=""
                  />
                  <span className="block">Receber contatos pelo WhatsApp;</span>
                </li>
                <li className="flex items-center h-20">
                  <Image
                    className="mr-4 h-8 w-8"
            ...
            <>
              ...
              <ul>
                ...
                <li className="flex items-center h-20">
                  ...
                  />
                  <span className="block">
                    Mas não se preocupe — oferecemos orçamentos gratuitos e com
                    preços acessíveis para quem está começando.
                  </span>
                </li>
              </ul>
            </>
